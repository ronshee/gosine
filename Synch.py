# -*- coding: utf-8 -*-
"""
The Gossiping Insert-Eliminate (GoSInE) Algorithm: Synchronous Version
@author: Ronshee
"""
...
itr=100         # Number of runs over the same instance for generating confidence plots
...
t = m**3            # length of time horizon, parametrized by m
